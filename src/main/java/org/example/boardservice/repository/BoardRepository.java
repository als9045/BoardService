...
public interface BoardRepository extends JpaRepository<BoardEntity, Long> {
    ...
    @Query("select b, r from BoardEntity b left join Reply r on r.board = b where b.bno =:bno")
    ...
    @Query(value = "select b, w, count(r) " +
            ...
            "group by b",
            countQuery = "select count(b) from BoardEntity b") //페이징 처리 시 전체 데이터 개수를 계산하여 총 페이지 수를 정확히 산출하기 위함
