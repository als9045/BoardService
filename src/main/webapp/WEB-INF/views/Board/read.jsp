    ...
    <div id="content" class="mt-4">
        <div class="row">
            <div class="col-12 form-container">
                <h1 class="mb-4">Board Read Page</h1>
                <form>
                    <table>
                        <tr>
                            <th>Bno</th>
                            <td><input type="text" name="bno" value="${dto.bno}" required></td>
                        </tr>
                        <tr>
                            <th>Title</th>
                        ...
                        <tr>
                            <th>Content</th>
                            <td><input type="text" name="content" value="${dto.content}" readonly></input></td>
                        </tr>
                        <tr>
                            <th>Writer Email</th>
